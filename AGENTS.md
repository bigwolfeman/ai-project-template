...
- **Classify research work first.** Before automated research, the agent names the work as a spike, an experiment, or a campaign. These terms are not synonyms. Homes: [lab/AGENTS.md](lab/AGENTS.md) and [docs/experiments/AGENTS.md](docs/experiments/AGENTS.md).
